...
â”œâ”€â”€ config/
â”‚   â””â”€â”€ mod.rs              # Configuration from env
â”œâ”€â”€ error/
â”‚   â””â”€â”€ mod.rs              # Error types (AnthropicError, etc.)
â”œâ”€â”€ anthropic/
â”‚   â”œâ”€â”€ mod.rs              # Public exports
â”‚   â”œâ”€â”€ client.rs           # AnthropicClient
â”‚   â”œâ”€â”€ types.rs            # ReasoningMode, Request/Response types
â”‚   â””â”€â”€ config.rs           # Model/temperature settings per mode
â”œâ”€â”€ prompts/
â”‚   â””â”€â”€ mod.rs              # All system prompts
â”œâ”€â”€ modes/
â”‚   â”œâ”€â”€ mod.rs              # Mode exports
â”‚   â”œâ”€â”€ core.rs             # ModeCore (storage + client)
â”‚   â”œâ”€â”€ linear.rs           # LinearMode
â”‚   â”œâ”€â”€ tree.rs             # TreeMode (with focus/list/complete)
â”‚   â”œâ”€â”€ divergent.rs        # DivergentMode
â”‚   â”œâ”€â”€ reflection.rs       # ReflectionMode (with evaluate)
â”‚   â”œâ”€â”€ checkpoint.rs       # CheckpointMode (create/list/restore)
â”‚   â”œâ”€â”€ auto.rs             # AutoMode (router)
â”‚   â”œâ”€â”€ graph.rs            # GraphMode (all GoT operations)
â”‚   â”œâ”€â”€ detect.rs           # DetectMode (biases/fallacies)
â”‚   â”œâ”€â”€ decision.rs         # DecisionMode (weighted/pairwise/topsis/perspectives)
â”‚   â”œâ”€â”€ evidence.rs         # EvidenceMode (assess/probabilistic)
â”‚   â”œâ”€â”€ timeline.rs         # TimelineMode (create/branch/compare/merge)
â”‚   â”œâ”€â”€ mcts.rs             # MctsMode (explore/auto_backtrack)
â”‚   â””â”€â”€ counterfactual.rs   # CounterfactualMode
â”œâ”€â”€ presets/
â”‚   â”œâ”€â”€ mod.rs
â”‚   â”œâ”€â”€ registry.rs         # Preset registry
â”‚   â””â”€â”€ executor.rs         # Preset execution
â”œâ”€â”€ server/
â”‚   â”œâ”€â”€ mod.rs              # AppState
â”‚   â”œâ”€â”€ mcp.rs              # JSON-RPC protocol
â”‚   â””â”€â”€ handlers.rs         # 15 tool handlers
â”œâ”€â”€ storage/
â”‚   â”œâ”€â”€ mod.rs              # Storage trait
â”‚   â””â”€â”€ sqlite.rs           # SQLite implementation
â”œâ”€â”€ metrics/
â”‚   â””â”€â”€ mod.rs              # Metrics collection
â””â”€â”€ self_improvement/
    â”œâ”€â”€ mod.rs              # Re-exports, documentation
    â”œâ”€â”€ system.rs           # Orchestrator (SelfImprovementSystem)
    â”œâ”€â”€ types.rs            # Core types (Severity, TriggerMetric, SuggestedAction)
    â”œâ”€â”€ monitor.rs          # Phase 1: Metric collection, baseline tracking
    â”œâ”€â”€ analyzer.rs         # Phase 2: LLM-powered diagnosis
    â”œâ”€â”€ executor.rs         # Phase 3: Action execution with safety
    â”œâ”€â”€ learner.rs          # Phase 4: Reward calculation, lesson synthesis
    â”œâ”€â”€ circuit_breaker.rs  # Safety: Halt on consecutive failures
    â”œâ”€â”€ allowlist.rs        # Safety: Validate action bounds
    â”œâ”€â”€ baseline.rs         # Baseline calculation (EMA + rolling)
    â”œâ”€â”€ config.rs           # Configuration structs
    â”œâ”€â”€ storage.rs          # Database operations
    â”œâ”€â”€ cli.rs              # CLI commands (status, history, pause, rollback, etc.)
    â””â”€â”€ anthropic_calls.rs  # LLM calls for diagnosis, action selection, learning
```
...
â”‚  â”‚ MONITOR  â”‚â”€â”€â”€â–¶â”‚ ANALYZER â”‚â”€â”€â”€â–¶â”‚ EXECUTOR â”‚â”€â”€â”€â–¶â”‚ LEARNER  â”‚       â”‚
...
â”‚  â”‚  CircuitBreaker â”‚ Allowlist â”‚ Storage â”‚ Baselines           â”‚    â”‚
...
â”œâ”€â”€ mod.rs              # Re-exports, system documentation
â”œâ”€â”€ system.rs           # Orchestrator (SelfImprovementSystem)
â”œâ”€â”€ types.rs            # Core types (Severity, TriggerMetric, SuggestedAction)
â”œâ”€â”€ monitor.rs          # Phase 1: Metric collection and baseline tracking
â”œâ”€â”€ analyzer.rs         # Phase 2: LLM-powered diagnosis
â”œâ”€â”€ executor.rs         # Phase 3: Action execution with safety
â”œâ”€â”€ learner.rs          # Phase 4: Reward calculation and lesson synthesis
â”œâ”€â”€ circuit_breaker.rs  # Safety: Halt on consecutive failures
â”œâ”€â”€ allowlist.rs        # Safety: Validate actions are within bounds
â”œâ”€â”€ baseline.rs         # Baseline calculation (EMA + rolling average)
â”œâ”€â”€ config.rs           # Configuration structs
â”œâ”€â”€ storage.rs          # Database operations
â”œâ”€â”€ cli.rs              # CLI commands
â””â”€â”€ anthropic_calls.rs  # LLM calls for self-improvement
```
...
tests/
â”œâ”€â”€ common/
â”‚   â””â”€â”€ mod.rs              # Shared test utilities, fixtures
â”œâ”€â”€ integration/
â”‚   â”œâ”€â”€ linear_mode.rs      # Linear reasoning integration tests
â”‚   â”œâ”€â”€ tree_mode.rs        # Tree reasoning integration tests
â”‚   â”œâ”€â”€ graph_mode.rs       # Graph-of-Thoughts integration tests
â”‚   â”œâ”€â”€ decision_mode.rs    # Decision analysis integration tests
â”‚   â””â”€â”€ full_workflow.rs    # End-to-end workflow tests
â””â”€â”€ mocks/
    â””â”€â”€ mod.rs              # Mock Anthropic client, mock storage
```
...
```bash
ANTHROPIC_API_KEY=your_api_key_here  # Required: Anthropic API key
```
...
â”‚ or Desktop  â”‚â—€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”‚             â”‚
...
|---------|-------|----------|
| `âœ— Failed to connect` | Binary not found | Check path in `claude mcp get mcp-reasoning` |
| `âœ— Failed to connect` | Missing API key | Add `--env ANTHROPIC_API_KEY=xxx` |
| `âœ— Failed to connect` | Binary not executable | `chmod +x mcp-reasoning` (Unix) |
...
â”‚   â”œâ”€â”€ COVERAGE_EXCLUSIONS.md
â”‚   â””â”€â”€ DESIGN.md
â”œâ”€â”€ migrations/
...
â”‚   â”‚   â”œâ”€â”€ mcts.rs
â”‚   â”‚   â””â”€â”€ counterfactual.rs
â”‚   â”œâ”€â”€ presets/
â”‚   â”‚   â”œâ”€â”€ mod.rs
â”‚   â”‚   â””â”€â”€ builtin.rs
â”‚   â”œâ”€â”€ prompts/
â”‚   â”‚   â”œâ”€â”€ mod.rs
â”‚   â”‚   â”œâ”€â”€ core.rs
â”‚   â”‚   â””â”€â”€ advanced.rs
â”‚   â”œâ”€â”€ self_improvement/
â”‚   â”‚   â”œâ”€â”€ mod.rs
â”‚   â”‚   â”œâ”€â”€ types.rs
...
â”‚   â”‚   â””â”€â”€ server_tests.rs
â”‚   â””â”€â”€ modes/
â”‚       â”œâ”€â”€ mod.rs
â”‚       â”œâ”€â”€ linear_tests.rs
â”‚       â”œâ”€â”€ tree_tests.rs
â”‚       â””â”€â”€ graph_tests.rs
â”œâ”€â”€ .env.example
â”œâ”€â”€ .gitignore
â”œâ”€â”€ Cargo.toml
â”œâ”€â”€ README.md
